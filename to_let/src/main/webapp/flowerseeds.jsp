...
<tr>
			...
			<%
						...
						String _scategory="Horticulture (flower seeds)";
			...
			<table cellpadding="5" cellspacing="0" border="0" width="80%" bgcolor="lightyellow">
						<tr bgcolor="green"><th colspan="4"><font color="white">HORTICULTURE (FLOWER SEEDS)</font></th></tr>
						...
						<tr><td></td>	<td><font color="red">IMAGE</font></td><td><font color="black"><img src="Productimage.jsp?product_id=<%=rs.getString(1)%>" width="100" height="100"><br><b>Product Id: <%=rs.getString(1) %></b><b></font></td><td></td></tr>
