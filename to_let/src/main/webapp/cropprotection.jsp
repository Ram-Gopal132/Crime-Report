...
<script type="text/javascript" lang="JavaScript" src="js/prog.js" ></script>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<table cellpadding="5" cellspacing="0" border="0" width="80%"
					bgcolor="lightyellow">
					<tr bgcolor="green">
						<th colspan="4"><font color="white">CROP PROTECTION</font></th>
					</tr>
					...
					<tr>
						<td></td>
						<td><font face="verdana" color="red">DESCRIPTION</font></td>
						<td><font color="black"><%=rs.getString(5)%></font></td>
						<td></td>
					</tr>
					<tr>
						<td></td>
						<td><font color="red">IMAGE</font></td>
						<td><font color="black"><img
								src="Productimage.jsp?product_id=<%=rs.getString(1)%>"
								width="100" height="100"></font></td>
						<td></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td colspan="4" align="center" ><a href="javascript: vcart('<%=rs.getString(1)%>')">Add to Cart</a></td>
